...
SIGrypt is an end-to-end encrypted and LoRa-based communication software. Operates on quantum resistant cryptography such as AES-256-CTR, SHA-384, and HMAC-SHA384. Designed to be a PSK model and P2P.
